...
public partial class QuotationMstWithoutGst
{
    ...
    public int? ProformaWithoutGstinvId { get; set; }
    ...
    public virtual TblProformaInvoiceMstWithoutGst? ProformaWithoutGstinv { get; set; }
