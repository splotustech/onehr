...
public class WFHLocationService
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("SPOneHRApp.WFHLocationService, SPOneHR", WFHLocationService.class, __md_methods);
	}

	public WFHLocationService ()
	{
		super ();
		if (getClass () == WFHLocationService.class) {
			mono.android.TypeManager.Activate ("SPOneHRApp.WFHLocationService, SPOneHR", "", this, new java.lang.Object[] {  });
		}
	}
